...
import MyContanct from "./MyContanct";
          ...
          <div className="mt-14 h-full px-3 py-4 overflow-y-auto  dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  <svg
                    className="text-3xl flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#ff4f9b] dark:group-hover:text-white"
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
                    viewBox="0 0 24 24"
